...
// Filtros de periodo: viven en ./filters (compartidos con el cliente).
export { PERIODS, periodFrom, parsePeriod, type Period } from "./filters";
import type { Period } from "./filters";
